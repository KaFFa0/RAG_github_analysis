...
def extract_score_from_payload(payload: dict[str, Any], criterion: Criterion) -> int:
    """Support score stored under score, criterion id, or wrapped criterion id"""
    if "score" in payload:
...
def build_markdown_report(results: list[dict[str, Any]]) -> str:
    lines = ["# Repository analysis report", ""]
    for item in results:
